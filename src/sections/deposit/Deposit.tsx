            ...
            <Dashboard>
                ...
                {alertPopup && (
                    <Popup
                        ...
                        description={[
                            "Вы уверены, что совершаете перевод в сети TRC-20 на указанный нами кошелёк?\n" +
                            "Проверьте его на корректность! Т.к. средства могут быть утеряны при неправильном вводе адреса \n" +
                            "или сети перевода!",
                            "Также, в случае, если средства не поступят, мы не сможем зачислить их на ваш баланс. " +
                            "Пожалуйста, убедитесь в правильности перевода!"
                        ]}
                        onClose={handleClosePopup}
                        firstChildren={<Button variant="popupGrey" onClick={() => setAlertPopup(false)}>Отменить</Button>}
                        secondChildren={<Button variant="popupBlack" onClick={handleClosePopup}>Я уверен, продолжить</Button>}
                    />
                )}
