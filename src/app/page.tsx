...
export default function Home() {
    return (
        <>
            ...
            <FeaturesInfo item={FeaturesItem}
                          bases={[
                              {
                                  order: "01",
                                  headline: "Максимизация прибыли через трафик",
                                  text: "Premiant LTD повышает конверсии и рентабельность рекламных кампаний, обеспечивая клиентам высокую отдачу от инвестиций."
                              },
                              {
                                  order: "02",
                                  headline: "Глобальный охват аудитории",
                                  text: "Сотрудничество с крупными сетями позволяет привлекать трафик со всего мира, увеличивая конверсии и доходы."
                              },
                              {
                                  order: "03",
                                  headline: "Гибкость и адаптивность",
                                  text: "Premiant LTD быстро реагирует на изменения рынка, повышая точность таргетинга и эффективность рекламы."
                              },
                              {
                                  order: "04",
                                  headline: "Инновации для оптимизации",
                                  text: "Современные алгоритмы и машинное обучение делают Premiant LTD лидером в сфере арбитража интернет-трафика."
                              },
                              {
                                  order: "05",
                                  headline: "Прозрачность и контроль",
                                  text: "Подробные отчеты обеспечивают полное понимание расходов и результатов кампаний."
                              },
                          ]}
            />
