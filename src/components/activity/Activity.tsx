...
const Activity: FC<ActivityProps> = ({children, headDescription, title, modTitle}) => {
    const router = useRouter();

    const handleCheckCompany = () => {
        router.push("https://find-and-update.company-information.service.gov.uk/company/11999555")
    }
            ...
            <div className={styles.wrapper}>
                <div className={styles.beanie}>
                    ...
                    <div className={styles.headline}>
                        <div className={styles.modifiedContainer}>
                            ...
                            <h1 className={styles.modifiedTitle}>{modTitle}</h1>
                        </div>
                ...
                <div className={styles.content}>
                    <div className={styles.activityContent}>
                        <div className={styles.scheme}>{children}</div>
                        <p className={styles.schemeText}>
                            ...
                            Мы используем передовые технологии и алгоритмы, включая методы машинного обучения и
                            аналитики.
                    ...
                    <div className={styles.checkCompany}>
                        <p className={styles.checkText}>
                            Мы нацелены на долгосрочный успех наших клиентов, постоянно совершенствуя наши услуги и
                            внедряя
                            современные технологии. Благодаря гибкому подходу и оперативной адаптации к изменениям на
                            рынке,
                            ...
                            контроль на каждом этапе сотрудничества. Это позволяет нашим клиентам уверенно управлять
                            своими
                        ...
                        <div className={styles.checkContainer}>
                            ...
                            <Button variant="check" onClick={handleCheckCompany}>Проверить компанию</Button>
                        </div>
                    </div>
                </div>
            </div>
