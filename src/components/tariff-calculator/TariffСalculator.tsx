            ...
            <div className={styles.calculatorContent}>
                ...
                <div className={styles.calculatorInner}>
                    ...
                    <section className={styles.tariffs}>
                        ...
                        <TariffComponent onClick={()=> handleNavigation("/register")} headline="ЭКСКЛЮЗИВ" price="40 000" percent="12.34" variant="fullWidthClip" term="6" active={investment !== null && investment >= 40000} />
                    </section>
                </div>
            </div>
