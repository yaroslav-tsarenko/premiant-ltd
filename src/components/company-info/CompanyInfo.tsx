    ...
    return (
        <div className={styles.info}>
            ...
            <div className={styles.textContainer}>
                ...
                <p className={styles.text}>Наша команда благодаря самым последним аналитическим инструментам и алгоритмам в области
                ...
                <p className={styles.text}>Мы постоянно внедряем и тестируем новые стратегии и инструменты, чтобы оставаться впереди
                    конкурентов
                ...
                <p className={styles.text}>Мы гордимся своей способностью адаптироваться к изменяющимся условиям рынка и предоставлять нашим
